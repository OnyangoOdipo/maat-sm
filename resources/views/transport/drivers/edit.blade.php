    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <form method="POST" action="{{ route('transport.drivers.update', $driver) }}" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" name="name" type="text" 
                                class="mt-1 block w-full" :value="old('name', $driver->name)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="license_number" name="license_number" type="text" 
                                class="mt-1 block w-full" :value="old('license_number', $driver->license_number)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="license_expiry" name="license_expiry" type="date" 
                                class="mt-1 block w-full" :value="old('license_expiry', $driver->license_expiry->format('Y-m-d'))" required />
                    ...
                    <div>
                        ...
                        <textarea id="notes" name="notes" rows="3" 
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('notes', $driver->notes) }}</textarea>
                        <x-input-error :messages="$errors->get('notes')" class="mt-2" />
                    </div>

                    <div class="flex items-center gap-4">
                        <x-primary-button>{{ __('Update Driver') }}</x-primary-button>
